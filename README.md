...
`Linux System Programming | Python | Network Programming`

### About Me:
👨🏻‍💻 an enthusiast sharing about my learnings in tech <br>✍️ writing articles about linux and networking at [SegF4ult](https://www.facebook.com/segf4ult) Facebook Page.<br>📚 currently learning C, Python, Linux internals, and Networking<br>🧑‍💻 I'm currently working on [lightweight-http-server](https://github.com/thihahtoozin/lightweight-http-server)
